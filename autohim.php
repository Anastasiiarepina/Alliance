...
<section class="section make-autohim">
  <div class="container">
    <div class="make-autohim-content-wrapper">
      <div class="make-autohim-content">
        <div class="separator"></div>
        <h2 class="section-title">Изготовление автохимии</h2>
        <p class="make-autohim-text">
...
<section class="section type-autohim">
  <div class="container">
    <div class="type-autohim-content">
        <div class="separator"></div>
        <h2 class="section-title">Виды автохимии</h2>
        <p class="type-autohim-text">
