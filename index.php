...
<html lang="ru">
  ...
  <body class="front-page">
      ...
      <div class="container">
        ...
        <div class="swiper swiper-1">
          ...
          <ul class="swiper-wrapper header-features">
            ...
            <li class="swiper-slide header-features-item">
              <svg class="sertificate-svg" width="36" height="36">
          ...
          <!-- Navigation buttons -->
          <div class="slider-buttons-1">
            <div class="slider-button-prev">
              <svg width="36" height="24">
                <use href="img/sprite.svg#arrow-prev-1"></use>
              </svg>
            </div>
            <div class="slider-button-next">
              <svg width="36" height="24">
                <use href="img/sprite.svg#arrow-next-1"></use>
              </svg>
            </div>
          </div>
          <!-- /.slider-buttons -->
    ...
    <section class="section founder">
      <img src="img/founder.jpeg" alt="founder" class="founder-photo" />
      <div class="container">
        <div class="founder-content-wrapper">
          <div class="founder-content">
            ...
            <p class="founder-text">
              ...
              массового участия. <br />А ещё действия представителей оппозиции,
            ...
            <a href="#" class="button-link"
              ><span class="founder-link-big">Подробнее о компании</span
              ><span class="founder-link-small">О нашей миссии</span></a
            >
          </div>
        </div>
      </div>
        ...
        <div class="clients-wrapper">
          <div class="clients-content">
            ...
            <ul class="clients-list">
              ...
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#wash"></use>
                </svg>
                Автомойки
              </li>
              <li class="clients-list-item">
              ...
              <li class="clients-list-item">
                <svg width="30" height="30" class="clients-list-icon">
                  <use href="img/sprite.svg#avtomakeup"></use>
                </svg>
        ...
        <div class="cta-form-wrapper container">
          <form action="" class="cta-form">
            ...
            <div class="input-group-wrapper">
              ...
              <div class="input-group">
                <input type="tel" class="input" id="user-name" placeholder="" />
